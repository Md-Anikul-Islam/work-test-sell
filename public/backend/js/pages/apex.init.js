var colors = ["#3bc0c3"],
    ...
    options = {
        ...
        plotOptions: { boxPlot: { colors: { upper: (colors = dataColors ? dataColors.split(",") : colors)[0], lower: colors[1] } } },
        stroke: { colors: ["#a1a9b1"] },
    },
    colors = ((chart = new ApexCharts(document.querySelector("#basic-boxplot"), options)).render(), ["#3bc0c3", "#47ad77", "#fa5c7c"]),
    options =
        ((dataColors = $("#scatter-boxplot").data("colors")) && (colors = dataColors.split(",")),
            {
                series: [
                    {
                        name: "Box",
...
var colors = ["#3bc0c3", "#47ad77", "#fa5c7c", "#39afd1"],
    ...
    options = {
        ...
        plotOptions: { candlestick: { colors: { upward: (colors = dataColors ? dataColors.split(",") : colors)[0], downward: colors[1] } } },
    ...
    options = {
        ...
        title: { text: "Monthly Inflation in Argentina, 2002", floating: !0, offsetY: 360, align: "center", style: { color: "#444" } },
    ...
    options = {
        ...
        series: [
            { name: "Website Blog", type: "column", data: [500, 510, 420, 680, 400, 415, 340, 360, 780, 340, 270, 180] },
    ...
    options =
        ((chart = new ApexCharts(document.querySelector("#basic-polar-area"), options)).render(),
            {
                ...
                theme: { monochrome: { enabled: !0, shadeTo: "light", color: "#f24f7c", shadeIntensity: 0.6 } },
            }),
